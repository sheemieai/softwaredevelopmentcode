...
public class GetPayrollTableData {
    public static ArrayList<HashMap<String, Object>> getPayrollTableData(String DATABASE_URL,
        ...
        try(Connection connection = DriverManager.getConnection(DATABASE_URL, DATABASE_USER, DATABASE_PASSWORD);
            ...
            while (resultSet.next()) {
                ...
                dataMap.put("retire401k", resultSet.getDouble("retire_401k"));
                dataMap.put("healthcare", resultSet.getDouble("health_care"));
