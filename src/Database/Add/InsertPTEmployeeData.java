...
public class InsertPTEmployeeData {
    public static HashMap<String, String> insertPTEmployeeData(General_Employee employee , Address address, PartTime_Payroll payroll,
        ...
        try {
            ...
            try (PreparedStatement statement = connection.prepareStatement(
                    "INSERT INTO payroll_pt (payID, pay_date, earnings, fed_tax, fed_med, fed_SS, state_tax, hourly_wage, empid) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)")) {
                statement.setInt(1, generatedEmpId);
                ...
                statement.setDouble(8, payroll.hourlyWage);
                statement.setInt(9, generatedEmpId);
                statement.executeUpdate();
            }
