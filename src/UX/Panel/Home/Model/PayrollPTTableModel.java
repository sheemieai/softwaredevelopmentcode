...
public class PayrollPTTableModel extends AbstractTableModel {
    private final ArrayList<HashMap<String, Object>> data;
    private final String[] columnNames = {"Employee Id", "Pay Id", "First Name", "Last Name", "Pay Date", "Earnings", "Fed Tax", "Fed Med", "Fed SS", "State Tax", "Hourly Wage"};

    public PayrollPTTableModel(ArrayList<HashMap<String, Object>> data) {
        this.data = data;
    }
